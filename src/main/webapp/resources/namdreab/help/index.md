...
ягоды черники или другую змейку. Если змейка нарвется на камень - уменьшается 
...
Итак, игрок [регистрируется на сервере](../../../register?gameName=namdreab),
указывая свой email.
...
* Движение на свободную клетку в сторону ближайшей черники.
* Движение к той черники, добраться до которой можно быстрее других.
